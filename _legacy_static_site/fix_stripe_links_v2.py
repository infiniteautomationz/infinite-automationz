...
bundles = [
    {
        "name": "The Digital Presence Bundle",
        "monthly": 14900,
        "setup": 99900
    },
    {
        "name": "The Operations & Scale Bundle",
        "monthly": 29900,
        "setup": 249900
    },
    {
        "name": "The Social Growth Bundle",
        "monthly": 19900,
        "setup": 149900
    }
]
...
for b in bundles:
    ...
    links[b["name"]] = plink["url"]
    print(f"Created {b['name']} -> {plink['url']}")
    
with open("bundle_links_v2.json", "w") as f:
    json.dump(links, f)
